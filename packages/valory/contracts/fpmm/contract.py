        ...
        **kwargs: Any,
        ...
        try:
            ...
            batch_workable_contract = ledger_api.api.eth.contract(
                abi=BATCH_TOTAL_SUPPLY_DATA["abi"],
                bytecode=BATCH_TOTAL_SUPPLY_DATA["bytecode"],
            )
            ...
            contract_creation_code = (
                batch_workable_contract.bytecode + encoded_input_data
            )
            ...
            non_zero_markets = [
                ...
                for market_address in ledger_api.api.codec.decode(
                    ["address[]"], encoded_markets
                )[0]
            ]
