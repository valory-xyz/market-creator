...
"""Round behaviour wiring for the omen_realitio_bond_withdraw_abci skill."""
...
class OmenRealitioBondWithdrawRoundBehaviour(AbstractRoundBehaviour):
    """OmenRealitioBondWithdrawRoundBehaviour."""

    initial_behaviour_cls = RealitioBondWithdrawBehaviour
    abci_app_cls = OmenRealitioBondWithdrawAbciApp
    behaviours = {RealitioBondWithdrawBehaviour}
