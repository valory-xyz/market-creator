...
"""Base behaviour + helpers for omen_realitio_bond_withdraw_abci.
...
SKILL_LOG_PREFIX = "[OmenRealitioBondWithdraw]"
...
class RealitioBondWithdrawBaseBehaviour(BaseBehaviour, ABC):
    """Base behaviour for the omen_realitio_bond_withdraw_abci skill."""
    ...
    @property
    def params(self) -> RealitioBondWithdrawParams:
        """Return the params."""
        return cast(RealitioBondWithdrawParams, super().params)
