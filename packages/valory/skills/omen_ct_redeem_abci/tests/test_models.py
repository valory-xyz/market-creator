...
"""Tests for the omen_ct_redeem_abci models."""
...
from packages.valory.skills.omen_ct_redeem_abci.models import (
    BenchmarkTool,
    CtRedeemParams,
    Requests,
    SharedState,
...
class TestSharedState:
    ...
    def test_abci_app_cls(self) -> None:
        ...
        assert SharedState.abci_app_cls is OmenCtRedeemAbciApp
...
class TestCtRedeemParams:
    ...
    def test_init_parses_all_params(self) -> None:
        ...
        with patch.object(BaseParams, "__init__", return_value=None):
            CtRedeemParams.__init__(mock_self, **kwargs)
        assert mock_self.ct_redeem_batch_size == 5
