...
from packages.valory.skills.omen_ct_redeem_abci.rounds import CtRedeemRound
...
CT_REDEEM_TX_SUBMITTER = "omen_ct_redeem"
...
class CtRedeemBehaviour(CtRedeemBaseBehaviour):
    """Build a multisend that redeems the next batch of winning CT positions."""

    matching_round = CtRedeemRound
    ...
    def _build_redeem_txs(
        ...
        batch_size = self.params.ct_redeem_batch_size
