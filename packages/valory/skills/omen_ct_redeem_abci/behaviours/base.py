...
from packages.valory.skills.omen_ct_redeem_abci.rounds import SynchronizedData
...
class CtRedeemBaseBehaviour(BaseBehaviour, ABC):
    """Base behaviour for the omen_ct_redeem_abci skill."""
    ...
    @property
    def params(self) -> CtRedeemParams:
        """Return the params."""
        return cast(CtRedeemParams, super().params)
