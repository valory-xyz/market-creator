...
"""This module contains the shared state for the omen_ct_redeem_abci skill."""
...
class CtRedeemParams(BaseParams):
    """Parameters for the omen_ct_redeem_abci skill."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.ct_redeem_batch_size = self._ensure(
            "ct_redeem_batch_size", kwargs, type_=int
        )
