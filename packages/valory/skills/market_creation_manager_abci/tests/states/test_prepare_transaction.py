...
"""Tests for the PrepareTransactionRound."""
...
class TestPrepareTransactionRound:
    """Tests for PrepareTransactionRound."""

    def test_inherits_tx_preparation_round(self) -> None:
        """Test class hierarchy."""
        assert issubclass(PrepareTransactionRound, TxPreparationRound)

    def test_payload_class(self) -> None:
        """Test payload class is inherited."""
        assert PrepareTransactionRound.payload_class == MultisigTxPayload

    def test_synchronized_data_class(self) -> None:
        """Test synchronized data class is inherited."""
        assert PrepareTransactionRound.synchronized_data_class == SynchronizedData

    def test_done_event(self) -> None:
        """Test done event is inherited."""
        assert PrepareTransactionRound.done_event == Event.DONE

    def test_none_event(self) -> None:
        """Test none event is inherited."""
        assert PrepareTransactionRound.none_event == Event.NONE

    def test_no_majority_event(self) -> None:
        """Test no majority event is inherited."""
        assert PrepareTransactionRound.no_majority_event == Event.NO_MAJORITY
