...
from packages.valory.skills.market_creation_manager_abci.behaviours.base import HTTP_OK, HTTP_NO_CONTENT
...
def dummy_ctx():
    ...
    context = MagicMock()
    context.benchmark_tool.measure.return_value.local.return_value.__enter__.return_value = None
    context.benchmark_tool.measure.return_value.local.return_value.__exit__.return_value = None
    context.benchmark_tool.measure.return_value.consensus.return_value.__enter__.return_value = None
    context.benchmark_tool.measure.return_value.consensus.return_value.__exit__.return_value = None
