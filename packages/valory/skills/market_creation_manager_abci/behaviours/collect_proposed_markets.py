...
"""This module contains the collect proposed markets behaviour."""
...
from packages.valory.skills.market_creation_manager_abci.rounds import CollectProposedMarketsPayload, CollectProposedMarketsRound
