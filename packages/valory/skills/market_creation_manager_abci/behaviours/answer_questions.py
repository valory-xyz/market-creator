...
"""This module contains the answer questions behaviour."""
...
class AnswerQuestionsBehaviour(MarketCreationManagerBaseBehaviour):
    ...
    def _get_payload(self) -> Generator[None, None, str]:
        ...
        if len(question_to_answer) == 0:
            yield AnswerQuestionsRound.NO_TX_PAYLOAD
            return
    ...
    def _get_answer_tx(
        ...
        if (
            ...
            yield None
            return
        # successful state response, construct and yield tx dict
