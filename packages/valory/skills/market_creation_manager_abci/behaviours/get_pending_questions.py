...
"""This module contains the GetPendingQuestionsBehaviour of the 'market_creation_manager_abci' skill."""
...
class GetPendingQuestionsBehaviour(MarketCreationManagerBaseBehaviour):
    """GetPendingQuestionsBehaviour (gets Omen pending questions to close markets)"""
