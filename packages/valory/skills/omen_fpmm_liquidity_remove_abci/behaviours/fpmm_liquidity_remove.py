...
TX_SUBMITTER_NAME = "omen_fpmm_liquidity_remove"


class FpmmLiquidityRemoveBehaviour(FpmmLiquidityRemoveBaseBehaviour):
    """Behaviour that removes LP funds from FPMM markets (and optionally merges positions)."""

    matching_round = FpmmLiquidityRemoveRound
    ...
    def _prepare_multisend(self) -> Generator[None, None, Optional[str]]:
        ...
        batch_size = self.params.fpmm_remove_batch_size
