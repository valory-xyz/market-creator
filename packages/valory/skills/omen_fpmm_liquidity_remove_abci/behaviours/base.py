...
"""Base behaviour for the omen_fpmm_liquidity_remove_abci skill."""
...
LOG_PREFIX = "[OmenFpmmLiquidityRemove]"
...
class FpmmLiquidityRemoveBaseBehaviour(BaseBehaviour, ABC):
    """Base behaviour for the omen_fpmm_liquidity_remove_abci skill."""
    ...
    @property
    def params(self) -> FpmmLiquidityRemoveParams:
        """Return the params."""
        return cast(FpmmLiquidityRemoveParams, super().params)
