...
"""This module contains the shared state and parameters for the omen_fpmm_liquidity_remove_abci skill."""
...
class SharedState(BaseSharedState):
    ...
    abci_app_cls: Type[AbciApp] = OmenFpmmLiquidityRemoveAbciApp
...
class FpmmLiquidityRemoveParams(BaseParams):
    """Parameters for the omen_fpmm_liquidity_remove_abci skill."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.liquidity_removal_lead_time: int = self._ensure(
            "liquidity_removal_lead_time", kwargs, type_=int
        )
        self.fpmm_remove_batch_size: int = self._ensure(
            "fpmm_remove_batch_size", kwargs, type_=int
        )
