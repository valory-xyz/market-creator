...
class TestSharedState:
    ...
    def test_abci_app_cls(self) -> None:
        ...
        assert SharedState.abci_app_cls is OmenFpmmLiquidityRemoveAbciApp
...
class TestFpmmLiquidityRemoveParams:
    ...
    def test_init_parses_all_params(self) -> None:
        ...
        with patch.object(BaseParams, "__init__", return_value=None):
            FpmmLiquidityRemoveParams.__init__(mock_self, **kwargs)

        assert mock_self.liquidity_removal_lead_time == 86400
        assert mock_self.fpmm_remove_batch_size == 3
