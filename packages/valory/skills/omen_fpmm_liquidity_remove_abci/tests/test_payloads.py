...
class TestFpmmLiquidityRemovePayload:
    """Tests for FpmmLiquidityRemovePayload."""

    def test_payload_defaults(self) -> None:
        """Test that payload has None defaults for optional fields."""
        payload = FpmmLiquidityRemovePayload(sender="0xsender")
    ...
    def test_payload_with_values(self) -> None:
        ...
        payload = FpmmLiquidityRemovePayload(
            sender="0xsender",
            tx_submitter="omen_fpmm_liquidity_remove",
            tx_hash="0xdeadbeef",
        )
        assert payload.tx_submitter == "omen_fpmm_liquidity_remove"
