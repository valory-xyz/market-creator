...
"""Tests for FpmmLiquidityRemoveBehaviour — covers the four-state matrix and helpers."""
...
def _make_behaviour(context: MagicMock) -> FpmmLiquidityRemoveBehaviour:
    """Instantiate a FpmmLiquidityRemoveBehaviour with a mocked context."""
...
class TestFpmmLiquidityRemoveBehaviour:
    """Tests for FpmmLiquidityRemoveBehaviour."""
    ...
    def setup_method(self) -> None:
        ...
        mock_ctx.params.fpmm_remove_batch_size = 3
        ...
        mock_ctx.state.round_sequence.current_round_id = "fpmm_liquidity_remove_round"
        mock_ctx.state.round_sequence.last_round_id = "fpmm_liquidity_remove_round"
    ...
    def test_state_1_open_far_from_close_produces_skip(self) -> None:
        ...
        # lead_time = 86400; now = 1700100000
        # opening_ts = 1700200000 → opening_ts - lead_time = 1700113600 > now
    ...
    def test_prepare_multisend_respects_batch_size(self) -> None:
        """Never processes more markets than fpmm_remove_batch_size."""
        # batch_size = 3; provide 5 markets classified as remove_only with valid txs
        self.ctx.params.fpmm_remove_batch_size = 2
