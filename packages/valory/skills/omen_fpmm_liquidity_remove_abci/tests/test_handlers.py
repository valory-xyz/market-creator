...
"""Tests for handlers in the omen_fpmm_liquidity_remove_abci skill."""

import packages.valory.skills.omen_fpmm_liquidity_remove_abci.handlers as handlers_module
