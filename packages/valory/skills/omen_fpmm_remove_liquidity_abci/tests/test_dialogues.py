...
"""Tests for dialogues in the omen_fpmm_remove_liquidity_abci skill."""

import packages.valory.skills.omen_fpmm_remove_liquidity_abci.dialogues as dialogues_module
