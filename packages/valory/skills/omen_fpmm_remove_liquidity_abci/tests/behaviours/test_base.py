...
class TestFpmmRemoveLiquidityBaseBehaviourProperties:
    """Tests for property accessors on FpmmRemoveLiquidityBaseBehaviour."""
    ...
    def setup_method(self) -> None:
        ...
        ctx.params.fpmm_remove_liquidity_batch_size = 3
...
class TestToMultisend:
    ...
    def test_returns_none_when_safe_hash_fails(self) -> None:
        ...
        with (
            ...
            patch.object(self.behaviour, "_get_safe_tx_hash", make_gen(None)),
        ):
            txs = [{"to": "0xA", "value": 0, "data": b""}]
            gen = self.behaviour._to_multisend(txs)
            result = exhaust_gen(gen)
