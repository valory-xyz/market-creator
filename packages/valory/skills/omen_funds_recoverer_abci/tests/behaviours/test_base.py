...
"""Tests for OmenFundsRecovererBaseBehaviour and base helpers."""
...
class TestOmenFundsRecovererBaseBehaviour:
    """Tests for OmenFundsRecovererBaseBehaviour using a concrete subclass."""

    def setup_method(self) -> None:
        """Set up test fixtures using ClaimBondsBehaviour as a concrete subclass."""
    ...
    def test_params(self) -> None:
        """Test params property returns cast OmenFundsRecovererParams."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("get_subgraph_result", "omen_subgraph"),
            (
                "get_conditional_tokens_subgraph_result",
                "conditional_tokens_subgraph",
            ),
            ("get_realitio_subgraph_result", "realitio_subgraph"),
        ],
    )
