...
"""Shared fixtures and helpers for omen_funds_recoverer_abci behaviour tests."""
...
def mock_context() -> MagicMock:
    ...
    context.params.claim_bonds_batch_size = 10
    ...
    context.conditional_tokens_subgraph = MagicMock()
    context.conditional_tokens_subgraph.get_spec.return_value = {
        "method": "POST",
