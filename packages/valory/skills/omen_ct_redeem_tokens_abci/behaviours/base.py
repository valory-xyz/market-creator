...
from packages.valory.skills.omen_ct_redeem_tokens_abci.rounds import SynchronizedData
...
SKILL_LOG_PREFIX = "[OmenCtRedeemTokens]"
...
class CtRedeemTokensBaseBehaviour(BaseBehaviour, ABC):
    ...
    def params(self) -> CtRedeemTokensParams:
        """Return the params."""
        return cast(CtRedeemTokensParams, super().params)
