...
"""Tests for CtRedeemTokensBaseBehaviour and base helpers."""
...
class TestCtRedeemTokensBaseBehaviour:
    """Tests for CtRedeemTokensBaseBehaviour using a concrete subclass."""

    def setup_method(self) -> None:
        """Set up test fixtures using CtRedeemTokensBehaviour as a concrete subclass."""
        ...
        self.behaviour: Any = CtRedeemTokensBehaviour(
    ...
    def test_params(self) -> None:
        """Test params property returns cast CtRedeemTokensParams."""
